...
\begin{Exercise}
    ...
    \ExePart
		We provide code that computes the proximal point sequence in a simple
		\texttt{Python} script. Example sequences can be found
		...
		\begin{figure}[h]
            ...
            \legend{$\lambda = 50$, $\lambda = 20$, $\lambda=5$};
            \end{axis}
            \end{tikzpicture}
